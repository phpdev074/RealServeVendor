    ...
    <div className="bg-white h-full relative overflow-hidden">
      <div className="bg-[#075e54] text-white px-4 py-3 pt-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-semibold">RealServ</div>
    ...
    <PhoneFrame showBottomNav={false}>
      <WhatsAppFrame>
        <WhatsAppBubble time="2:30 PM">
          <div className="text-sm">Hello! I'm interested in becoming a RealServ vendor for cement supply in Miyapur area.</div>
        </WhatsAppBubble>
      ...
      <div className="bg-white h-full overflow-y-auto">
        ...
        <div className="p-4 pb-24">
          ...
          <div className="bg-white border-2 border-gray-300 rounded-xl p-4 mb-3">
            ...
            <input type="text" placeholder="Full Name" className="w-full bg-gray-50 border-2 border-gray-300 rounded-lg p-3 text-sm mb-2" value="Rajesh Kumar" readOnly />
            <input type="text" placeholder="Business Name" className="w-full bg-gray-50 border-2 border-gray-300 rounded-lg p-3 text-sm mb-2" value="Kumar Cement Suppliers" readOnly />
            <input type="text" placeholder="Phone Number" className="w-full bg-gray-50 border-2 border-gray-300 rounded-lg p-3 text-sm mb-2" value="+91 98765 43210" readOnly />
    ...
    <PhoneFrame showBottomNav={false}>
      <WhatsAppFrame>
        <WhatsAppBubble sent time="4:15 PM">
          ...
          <div className="text-sm mt-2">RealServ operates with:</div>
    ...
    <PhoneFrame showBottomNav={false}>
      <WhatsAppFrame>
        <WhatsAppBubble sent time="4:20 PM">
          ...
          <div className="text-sm mt-2">Welcome to RealServ, Rajesh!</div>
        </WhatsAppBubble>
        ...
        <WhatsAppBubble sent time="4:21 PM">
          <div className="text-sm">Portal: vendor.realserv.in</div>
          <div className="text-sm mt-1">Login: +91 98765 43210</div>
