      ...
      <div className="max-w-2xl w-full">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6 hover:shadow-md transition-all hover:border-error-200">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-neutral-600 mb-4">
                  Operations control center for RealServ team to manage marketplace operations
                </p>
                <div className="flex items-center gap-2 text-xs text-neutral-500 mb-4">
                  <span className="inline-flex items-center gap-1">
                    <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-neutral-500">
            RealServ MVP • Hyperlocal Construction Materials Marketplace • Hyderabad
          </p>
        </div>
      </div>
    </div>
