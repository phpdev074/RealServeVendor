    ...
    replies: [
      {
        ...
        isVendorReply: false,
        authorName: 'Rajesh Kumar (Support)',
...
export const mockFAQs: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'Your payout is calculated as: Base Price (your catalog price) minus RealServ Commission (15-18% depending on category and volume). The exact breakdown is shown in each order details page. Higher order volumes may qualify you for reduced commission rates.',
    helpful: 52,
    views: 145,
  },
  {
    ...
    answer: 'To add new items, create a support ticket under "Catalog Update Request" with details about the item, your pricing, stock availability, and any certifications. Our team will review and add the item within 24 hours if approved. Not all items can be added - they must meet RealServ quality standards.',
    helpful: 29,
    views: 75,
    relatedLinks: [
