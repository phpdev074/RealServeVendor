...
/**
 * Mock Vendor Orders
 * Sample orders for Kumar Cement Suppliers
 */
export const mockVendorOrders: VendorOrder[] = [
  ...
  // Orders for RK Steel & Hardware (vendor_03)
...
/**
 * Helper function to generate orders for RK Steel & Hardware (vendor_03)
 */
