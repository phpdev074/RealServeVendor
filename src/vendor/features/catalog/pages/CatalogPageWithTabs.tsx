...
export function CatalogPage() {
  ...
  const currentCounts = activeTab === 'materials' ? counts : serviceCounts;
  const currentFiltered = activeTab === 'materials' ? filteredItems : filteredServices;
        ...
        <TabsContent value="materials">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-primary-50 border-2 border-primary-200 rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-primary-900 mt-1">{counts.inCatalog}</p>
            </div>
            <div className="bg-white border-2 border-neutral-200 rounded-xl p-4">
              <p className="text-sm text-neutral-600">Available to Add</p>
              <p className="text-2xl font-bold text-neutral-900 mt-1">{counts.available}</p>
            </div>
          </div>
        ...
        <TabsContent value="services">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="bg-white border-2 border-neutral-200 rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-neutral-900 mt-1">{serviceCounts.all}</p>
            </div>
            <div className="bg-primary-50 border-2 border-primary-200 rounded-xl p-4">
              <p className="text-sm text-primary-700">In My Catalog</p>
              <p className="text-2xl font-bold text-primary-900 mt-1">{serviceCounts.inCatalog}</p>
            </div>
            <div className="bg-white border-2 border-neutral-200 rounded-xl p-4">
              <p className="text-sm text-neutral-600">Available to Add</p>
              <p className="text-2xl font-bold text-neutral-900 mt-1">{serviceCounts.available}</p>
            </div>
          </div>
